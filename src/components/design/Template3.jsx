    ...
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32 bg-gray-100 rounded-lg">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          <div
            className="w-full h-auto bg-white px-8 py-8"
          ...
          >
            ...
            <div className="w-full">
              <div className="flex items-center justify-start">
                <input
                  ...
                  className={`bg-transparent outline-none border-none text-3xl uppercase tracking-wider text-txtDark font-semibold ${
              ...
              <input
                ...
                type="text"
                readOnly={true}
                className={`bg-transparent outline-none border-none text-xl tracking-wide capitalize text-txtPrimary w-full ${
                  isEdit && "text-black"
                }`}
              />
              ...
              <input
                ...
                type="text"
                readOnly={true}
                className={`outline-none border-none w-52 text-xs ${
                  isEdit ? "bg-gray-200" : "bg-transparent"
                }`}
              />
              ...
              <input
                readOnly={true}
                className={`text-xs w-full outline-none border-none mb-3 ${
                  isEdit ? "bg-gray-200" : "bg-transparent"
                }`}
                name="address"
            ...
            <div className="w-full flex flex-col items-center justify-start py-3 gap-6">
              <div className="w-full">
                <p className="capitalize text-xl tracking-wider flex gap-2 items-center text-txtPrimary">
                  Summary
                </p>
                <textarea
                  readOnly={true}
              ...
              {/* Education */}
              <div className="w-full">
                <p className="capitalize text-xl tracking-wider flex gap-2 items-center">
                  Education
                </p>
                <AnimatePresence>
                  {education &&
              ...
              {/* skills */}
              <div className="w-full -m-5 pb-5">
                <p className="capitalize text-xl tracking-wider">Skills</p>
            ...
            <div className="w-full h-full flex flex-col items-start justify-start gap-6">
              ...
              <div className="w-full py-3">
                <p className="capitalize text-xl tracking-wider">Projects</p>
            ...
            <div className="w-full flex flex-col items-start justify-start gap-6">
              {/* Certificates */}
              <div className="w-full py-3">
                <p className="capitalize text-xl tracking-wider">
                  Certificates
                </p>
