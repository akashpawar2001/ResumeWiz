    ...
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32 bg-gray-100 rounded-lg">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          <div
            className="w-[210mm] bg-white px-8 py-8"
          ...
          >
            ...
            <div className="w-full flex flex-col justify-center items-center">
              <div className="text-center">
                <input
                  ...
                  className={`bg-transparent outline-none text-center border-none text-3xl uppercase tracking-wider text-txtDark font-semibold ${
                ...
                <input
                  ...
                  type="text"
                  readOnly={true}
                  className={`bg-transparent text-center outline-none border-none text-xl tracking-wide capitalize text-txtPrimary w-full ${
                    isEdit && "text-black"
                  }`}
                />
              </div>
              <div className="flex gap-2">
                ...
                <input
                  ...
                  type="text"
                  readOnly={true}
                  className={`outline-none border-none w-[200px] text-xs ${
                    isEdit ? "bg-gray-200" : "bg-transparent"
                  }`}
                />
              ...
              <div className="w-full">
                <input
                  readOnly={true}
                  className={`text-xs w-full text-center outline-none border-none ${
                    isEdit ? "bg-gray-200" : "bg-transparent"
                  }`}
                  name="address"
            ...
            <div className="w-full flex flex-col items-center justify-start py-1">
              <div className="w-full">
                <p className="capitalize font-semibold text-xl tracking-wider flex gap-2 items-center justify-center text-txtPrimary">
                  Summary
                </p>
                ...
                <textarea
                  ...
                  className={`resize-none text-txtPrimary w-full outline-none border-none mt-3 ${
                    isEdit ? "bg-gray-200" : "bg-transparent"
                  }`}
              ...
              {/* Education */}
              <div className="w-full">
                <p className="capitalize font-semibold text-xl tracking-wider flex gap-2 justify-center items-center">
                  Education
                </p>
                <div className="w-full h-[1px] bg-black mt-2"></div>
                <AnimatePresence>
              ...
              {/* skills */}
              <div className="w-full ">
                <p className="capitalize font-semibold text-xl tracking-wider flex items-center justify-center">
                  Skills
                </p>
                <div className="w-full h-[1px] bg-black mt-2"></div>
                      ...
                      skills?.map((skill, i) => (
                        ...
                        >
                          <textarea
                            ...
                            type="text"
                            readOnly={true}
                            className={`resize-none outline-none border-none tracking-wide capitalize text-txtPrimary w-full ${
                              isEdit ? "bg-gray-200" : "bg-transparent"
                            }`}
                            style={{
                              height: "30px",
                          ...
                          <div className="relative">
                            ...
                            <div className="flex gap-2 mb-1">
                              <input
                                ...
                                type="text"
                                readOnly={true}
                                className={` outline-none border-none font-sans text-md tracking-wide capitalize text-txtDark w-full ${
                                  isEdit ? "bg-gray-200" : "bg-transparent"
                                }`}
                              />
                              {isEdit === true ? (
                            ...
                            <textarea
                              readOnly={true}
                              onInput={(e) => handleAutoResize(e)}
                              className={`text-xs tracking-wider w-full outline-none border-none ${
                                isEdit ? "bg-gray-200" : "bg-transparent"
                              }`}
                              name="description"
            ...
            <div className="w-full flex flex-col items-start justify-start">
              ...
              <div className="w-full">
                ...
                <div className="w-full h-[1px] bg-black mt-2"></div>
                <div className="w-full mt-3 flex flex-col items-center justify-start gap-4">
                  <AnimatePresence>
                    {certificates &&
                          ...
                          <div className="relative">
                            ...
                            <div className="flex gap-2 mb-1">
                              <input
                                ...
                                type="text"
                                readOnly={true}
                                className={` outline-none border-none text-md tracking-wide capitalize text-txtDark w-full ${
                                  isEdit ? "bg-gray-200" : "bg-transparent"
                                }`}
                              />
                              {isEdit === true ? (
